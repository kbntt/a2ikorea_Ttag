...
<html lang="ko">
    ...
    <head>
        ...
        <link rel="stylesheet" href="./resources/css/user-search_id.css"/>
    ...
    <body>
        ...
        <!-- section -->
        <div id="section">
            <form name="search_ic" class="search" method="post">
                <fieldset>
                    <legend>아이디&nbsp;찾기</legend>
                    <li class="search_btn">
                        <label>
                            <button type="reset" title="search_id">아이디&nbsp;찾기</button>
                        </label>
                        <label>
                            <button
                                type="button"
                                onclick="location.href='search_password.jsp'"
                                title="search_password">비밀번호&nbsp;찾기</button>
                        </label>
                    </li>
